...
export enum ViewProjectPageText {
  ...
  PageSubHeaderText = 'View project details or edit project information by clicking on the edit button',
  ProjectText = 'Project:',
  EditButtonText = 'Edit',
  EditAllButtonText = 'Edit All',
}
...
export enum CreateProjectPageText {
  ...
  PageSubHeaderText = 'Create a new project and include any additional information if necessary',
  SaveButtonText = 'Save',
}
...
export enum CreateDepartmentPageText {
  ...
  PageSubHeaderText = 'Create a new department and include a description',
  SaveButtonText = 'Save',
}
